function Feature=ExtractFeatures(im, c1, c2, ncomp, digitBinsToKeep)
    % Extract Benford distribution features as described in Amerini, Irene,
    % Rudy Becarelli, Roberto Caldelli, and Andrea Del Mastio. "Splicing
    % forgeries localization through the use of first digit features." In
    % Information Forensics and Security (WIFS), 2014 IEEE International
