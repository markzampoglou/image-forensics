function [OutputMap, Feature_Vector, coeffArray] = detectDQ( im )
    ...
    % Depending on whether im was created using jpeg_read or
    % CleanUpImage(/imread), call a different version of the algorithm.
    % jpeg_read produces more robust results, but it requires
