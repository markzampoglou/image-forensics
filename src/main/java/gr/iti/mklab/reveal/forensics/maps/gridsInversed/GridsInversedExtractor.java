package gr.iti.mklab.reveal.forensics.maps.gridsInversed;
...
public class GridsInversedExtractor {

    public BufferedImage displaySurface = null;
    public double gridsInversedmin;
    public double gridsInversedmax;
    ...
    public GridsInversedExtractor(String fileName) throws IOException {
