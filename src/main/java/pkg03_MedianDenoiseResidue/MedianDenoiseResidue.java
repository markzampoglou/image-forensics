 ...
 */
public class MedianDenoiseResidue {
    ...
    public MedianDenoiseResidue(String FileName) throws IOException {
    ...
    public void GetNoiseMap() throws IOException {
        ...
        MultiSpectral<ImageUInt8> Original=null;

        MultiSpectral<ImageUInt8> MedianFiltered=null;
        ImageUInt8 MedianBand=null;
       Original=ConvertBufferedImage.convertFromMulti(InputImage,null,ImageUInt8.class);


        //Temporarily commented out to compile
        //MedianFiltered=BlurImageOps.median(Original,null,8);

        MedianFiltered.bands[1].setTo(MedianBand);


                //(InputImage, null, true, ImageUInt8.class);
/*
        long Begin;
        ...
        for (int ii = 0; ii < ImWidth; ii++) {
            try {
                ...
                Logger.getLogger(MedianDenoiseResidue.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
